...
const UserReservationForm = () => {
 ...
 useEffect(() => {
  ...
  if (!slot) return <Loader text="Loading slot information..." />
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen px-6 py-10 gap-8">
              ...
              {[
                ...
                <li
                  ...
                  className={`flex items-center gap-3 transition ${
                    step === index + 1
                      ? 'text-[#00509e] font-semibold'
                      : 'text-gray-500'
                  }`}
                >
                  <item.icon
                    className={`w-6 h-6 ${
                      step === index + 1 ? 'text-[#00509e]' : 'text-gray-400'
                    }`}
                  />
        ...
        <div className="rounded-2xl w-full max-w-3xl p-6 sm:p-10 bg-white">
          <form className="w-full">
            ...
            {step === 5 && (
              <Step5 reservationResult={reservationResult} navigate={navigate} />
            )}
          </form>
        </div>
      </div>
