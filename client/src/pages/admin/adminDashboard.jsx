...
const AdminDashboard = () => {
  ...
  <>
    ...
    <div className="flex flex-col gap-y-12 px-8 lg:px-16 py-10 bg-gray-50 min-h-screen">
      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-5xl bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b bg-gradient-to-r from-[#3366CC]/10 to-[#9460C9]/10">
