  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <motion.div
        ...
        className="flex flex-col items-center justify-center mt-10 px-6 text-center flex-grow"
      >
        <h2 className="text-[28px] lg:text-[36px] font-bold text-color">
          Welcome back, <span className="text-color-3">{auth.user.firstname}!</span>
        </h2>
        <p className="text-sm text-color-2 mt-3 mb-5 max-w-2xl">
          Manage your parking effortlessly — reserve slots, view your recent activities,
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center px-6 pb-12 flex-grow overflow-y-auto"
      >
        <motion.div
          variants={fadeUp}
